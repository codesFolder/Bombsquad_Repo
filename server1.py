...
PAUSE_FAV_START_X = -170         # starting X position
PAUSE_FAV_Y = -50               # vertical position from bottom
PAUSE_FAV_SIZE = (100, 30)     # width, height
PAUSE_FAV_GAP_X = 130          # horizontal gap between buttons
PAUSE_FAV_COLOR = (0.2, 0.6, 1)

# Favourite buttons in main menu
MAIN_FAV_START_X = -50
MAIN_FAV_Y = 90
MAIN_FAV_SIZE = (100, 30)
MAIN_FAV_GAP_X = 130
